...
class Component(component.Main):
    ...
    def addObjects(self):
        ...
        for i in range(self.settings["fkNb"]):
            ...
            cns1 = primitive.addTransform(self.root, self.getName("%s_addCns" % i))
            self.div_cns1.append(cns1)
    ...
    def addOperators(self):
        ...
        for i in range(self.settings["fkNb"]):
            ...
            # Roll
            # intMatrix = applyop.gear_intmatrix_op( self.ik_ctl[0] + ".worldMatrix", self.ik_ctl[-1] + ".worldMatrix", u)

            mp = applyop.pathCns(self.div_cns1[i], self.mst_crv, False, u, True)
            intMatrix
