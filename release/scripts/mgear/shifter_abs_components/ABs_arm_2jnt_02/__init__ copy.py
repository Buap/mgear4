...
class Component(MainComponent):
    ...
    def addObjects(self):
        ...
        pm.parent(self.limbBones[0], self.upperArm_loc)

        # limb chain FK ref
        self.limbBonesFK = pri.add2DChain(self.root, self.getName("limbFK%s_jnt"), self.guide.apos[0:3], self.normal, False, self.WIP)
        pm.parent(self.limbBonesFK[0], self.upperArmFK_loc)

        # limb chain IK ref
        self.limbBonesIK = pri.add2DChain(self.root, self.getName("limbIK%s_jnt"), self.guide.apos[0:3], self.normal, False, self.WIP)
        pm.parent(self.limbBonesIK[0], self.upperArmIK_loc)
        ...
        self.fk0_npo = pri.addTransform(self.upperArmFK_loc, self.getName("fk0_npo"), t)
