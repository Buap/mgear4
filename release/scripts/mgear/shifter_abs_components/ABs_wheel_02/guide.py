...
class Guide(guide.ComponentGuide):
    ...
    # @param self
    def postInit(self):
        self.save_transform = ["root", "radius", "up"]
    ...
    def addObjects(self):
        ...
        self.radius = self.addLoc("radius", self.root, vTemp)

        vTemp = transform.getOffsetPosition(self.root, [0, 1, 0])
        
        self.up = self.addLoc("up", self.root, vTemp)
        pm.delete(self.up.getShapes())
        attribute.lockAttribute(self.up)
